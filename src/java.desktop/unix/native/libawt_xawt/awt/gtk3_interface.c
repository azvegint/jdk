...
gchar *SCREENSHOT_NAME_SHM = "/javaWaylandXXXXXX"; // TODO: new name for each screenshot
#else
...
jstring gtk3_doScreenshot(JNIEnv *env, int x, int y, int width, int height) {
    ...
    // https://github.com/vinzenz/gnome-shell/blob/master/data/org.gnome.Shell.Screenshot.xml#L66
    ...
    if (!err) {
        ...
        // https://github.com/vinzenz/gnome-shell/blob/master/data/org.gnome.Shell.Screenshot.xml#L72
