...
final class XRobotPeer implements RobotPeer {
    ...
    public void mouseMove(int x, int y) {
        // TODO what if partial permission granted
        if (XdgDesktopPortal.isRemoteDesktop() && ScreencastHelper.isAvailable()) { //TODO cache it?
    ...
    public int getRGBPixel(int x, int y) {
        ...
        if ((XdgDesktopPortal.isScreencast()
                || XdgDesktopPortal.isRemoteDesktop()) && ScreencastHelper.isAvailable()) {// TODO via remote desktop
