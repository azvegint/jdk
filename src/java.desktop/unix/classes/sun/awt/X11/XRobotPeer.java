...
final class XRobotPeer implements RobotPeer {
    ...
    XRobotPeer(X11GraphicsDevice gd) {
        ...
        boolean waylandRobotProp = Boolean.parseBoolean(System.getProperty("awt.robot.useDbusApi", "false"));

        useDbusApi = useGtk && waylandRobotProp;

        System.err.println(
            "Use DBUS API for screen capture: " + useDbusApi + " awt.robot.useDbusApi: " + waylandRobotProp
        );
    }
